...
Over the past three decades, my research has centered on understanding the evolving risks posed by atmospheric hazards, especially tropical cyclones and tornadoes, within a changing climate. By combining statistical methods, nonlinear systems analysis, and a focus on societal impact, I have worked to bridge gaps between atmospheric dynamics and practical applications in forecasting, risk management, and climate adaptation. This document summarizes key contributions that have collectively advanced the science of climate extremes and informed policy and resilience strategies.

---

## The intensification of tropical cyclones in a warming world

One of my most cited works, *The increasing intensity of the strongest tropical cyclones* (Elsner, Kossin, & Jagger, 2008)^[See [Publications](https://myweb.fsu.edu/jelsner/_site/publications.html) for links], offered statistical evidence that the most intense hurricanes globally are becoming even stronger. By applying quantile regression to best-track datasets, we demonstrated that the upper quantiles of maximum wind speed distributions are rising more rapidly than average values, directly linking sea surface warming to the intensification of the strongest storms. This finding, published in *Nature*, continues to underpin assessments by the IPCC and national climate reports. This work was complemented by additional studies that explored the trade-off between frequency and intensity in global cyclones, revealing that while the total number of storms may fluctuate or decline slightly, the proportion of high-intensity systems is increasing (Kang & Elsner, 2015). In recent extensions, I have examined the continuing rise in maximum intensities, validating and extending the 2008 findings with updated datasets and statistical refinements.
...
Taken together, this corpus of work has helped shape how scientists, planners, and policymakers understand the evolving risks from hurricanes and tornadoes under climate change. From identifying intensification trends in the most powerful tropical cyclones, to new methods for extracting climate signals and representing risks probabilistically, my contributions underscore the importance of coupling data analysis with societal relevance. As climate hazards continue to evolve, these approaches will remain essential for building resilient communities.^[This document benefited from drafting support by OpenAI's ChatGPT, which helped summarize, organize, and format the material.]
